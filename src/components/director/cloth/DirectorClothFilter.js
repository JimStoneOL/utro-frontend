...
export const DirectorClothFilter=({dataList,update})=>{
    ...
    const changeHandler = event => {
      ...
      if(searching){
        ...
        {<DirectorClothList dataList={searchCloth} update={update}/>}
        </>)
      }else
      ...
      if(filtering){
        ...
        {<DirectorClothList dataList={filterCloth} update={update}/>}
      ...
      return(
        ...
        {dataList && !searching && !filtering && <DirectorClothList dataList={dataList} update={update}/>}
        </>
      )
}
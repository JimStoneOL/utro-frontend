...
import { DirectorProductImageList } from "./DirectorProductImageList"


export const DirectorProductImageRepository=()=>{
    ...
    <br/>
       <div className="pink lighten-5 center" style={{height:'30px',borderRadius:'50px'}}>
                ...
                <br/>
    {productImage.length>0 && !loading && <DirectorProductImageList dataList={productImage} productId={productId} update={getAllProductImages}/>}
    </>)
}
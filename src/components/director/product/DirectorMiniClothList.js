...
import { DirectorMiniClothCard } from "./DirectorMiniClothCard"



export const DirectorMiniClothList=({dataList,selectCloth})=>{
            ...
            dataList.map((item,i)=>{ 
              ...
              return(
               ...
               <li>
                    ...
                    <DirectorMiniClothCard data={item} selectCloth={selectCloth}/>
                      </div>
                    </li>
               </>

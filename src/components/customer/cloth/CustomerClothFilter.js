...
export const CustomerClothFilter=({dataList})=>{
    ...
    const changeHandler = event => {
      ...
      if(searching){
        ...
        {<CustomerClothList dataList={searchCloth}/>}
        </>)
      }else
      ...
      if(filtering){
        ...
        {<CustomerClothList dataList={filterCloth}/>}
      ...
      return(
        ...
        {dataList && !searching && !filtering && <CustomerClothList dataList={dataList}/>}
        </>
      )
}
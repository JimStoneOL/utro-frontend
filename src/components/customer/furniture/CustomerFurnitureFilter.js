...
export const CustomerFurnitureFilter=({dataList})=>{
    ...
    const changeHandler = event => {
      ...
      if(searching){
        ...
        {<CustomerFurnitureList dataList={searchFurniture}/>}
        </>)
      }else
      ...
      if(filtering){
        ...
        {<CustomerFurnitureList dataList={filterFurniture}/>}
        </>)
      }
      ...
      return(
        ...
        {dataList && !searching && !filtering && <CustomerFurnitureList dataList={dataList}/>}
        </>
      )
}
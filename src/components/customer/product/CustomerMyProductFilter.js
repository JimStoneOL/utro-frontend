...
import { CustomerMyProductList } from "./CustomerMyProductList";
...
export const CustomerMyProductFilter=({dataList})=>{
    ...
    const changeHandler = event => {
      ...
      if(searching){
        ...
        {<CustomerMyProductList dataList={searchProduct}/>}
        </>)
      }else
      ...
      if(filtering){
        ...
        {<CustomerMyProductList dataList={filterProduct}/>}
      ...
      return(
        ...
        {dataList && !searching && !filtering && <CustomerMyProductList dataList={dataList}/>}
        </>
      )
}
...
import { CustomerProductImageList } from "./CustomerProductImageList"


export const CustomerProductImageRepository=()=>{
    ...
    <br/>
    <br/>
    {productImage.length>0 && !loading && <CustomerProductImageList dataList={productImage}/>}
    </>)
}
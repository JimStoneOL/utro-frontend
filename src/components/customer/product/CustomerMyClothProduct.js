...
export const CustomerMyClothProduct=()=>{
    ...
    const getCloth = useCallback(async () => {
        try {
          const clothProductFetched = await request(`https://morning-production-app.herokuapp.com/api/cloth/product/get/product/${productId}`, 'GET', null, {

...
export const CustomerProductFilter=({dataList})=>{
    ...
    const changeHandler = event => {
      ...
      if(searching){
        ...
        {<CustomerProductList dataList={searchProduct}/>}
        </>)
      }else
      ...
      if(filtering){
        ...
        {<CustomerProductList dataList={filterProduct}/>}
      ...
      return(
        ...
        {dataList && !searching && !filtering && <CustomerProductList dataList={dataList}/>}
        </>
      )
}
...
import { TakedManagerOrderShow } from "./TakedManagerOrderShow";

export const TakedManagerOrderFilter=({dataList})=>{
    ...
    const stages = [
      ...
      if(searching){
        ...
        {<TakedManagerOrderShow dataList={searchOrder}/>}
        </>)
      }
      ...
      <br/>
         ...
         {dataList && !searching && <TakedManagerOrderShow dataList={dataList}/>}
      </>)
}
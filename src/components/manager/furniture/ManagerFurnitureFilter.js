...
export const ManagerFurnitureFilter=({dataList,update})=>{
    ...
    const changeHandler = event => {
      ...
      if(searching){
        ...
        {<ManagerFurnitureList dataList={searchFurniture} update={update}/>}
        </>)
      }else
      ...
      if(filtering){
        ...
        {<ManagerFurnitureList dataList={filterFurniture} update={update}/>}
        </>)
      }
      ...
      return(
        ...
        {dataList && !searching && !filtering && <ManagerFurnitureList dataList={dataList} update={update}/>}
        </>
      )
}
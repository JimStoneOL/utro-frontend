...
import { ManagerMiniClothCard } from "./ManagerMiniClothCard"




export const ManagerMiniClothList=({dataList,selectCloth})=>{
            ...
            dataList.map((item,i)=>{ 
              ...
              return(
               ...
               <li>
                    ...
                    <ManagerMiniClothCard data={item} selectCloth={selectCloth}/>
                      </div>
                    </li>
               </>

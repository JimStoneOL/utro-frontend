...
export const ManagerProductFilter=({dataList})=>{
    ...
    const changeHandler = event => {
      ...
      if(searching){
        ...
        {<ManagerProductList dataList={searchProduct}/>}
        </>)
      }else
      ...
      if(filtering){
        ...
        {<ManagerProductList dataList={filterProduct}/>}
      ...
      return(
        ...
        {dataList && !searching && !filtering && <ManagerProductList dataList={dataList}/>}
        </>
      )
}